      ...
      <div className="page-header">
        <div className="header-left">
          <div className="logo-image">
                  <a href="/">
                    <img src={process.env.PUBLIC_URL+'/images/wigo-logo-img.png'} width="70" height="36" alt="Wigo Store" itemProp="logo"/>
                  </a>
              </div>
              <div className="header-menu">
              {userInfo && !userInfo.isAdmin ?  <nav className="navigation">
                  <ul>
            ...
            <div className="header-right">
              ...
              {userInfo ? (
                ...
                <a href='/register'>
                  ...
                  {userInfo && !userInfo.isAdmin ? <a href="/cart/:id" className="cart-link">
